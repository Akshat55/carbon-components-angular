...
git pull git:${GH_TOKEN}@github.com/akshat55/carbon-components-angular.git gh-pages
...
if [ $? -eq 0 ]; then
	echo "In here"
	git push --force git:${GH_TOKEN}@github.com/akshat55/carbon-components-angular.git HEAD:gh-pages
